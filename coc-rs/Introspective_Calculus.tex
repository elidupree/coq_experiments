...
%    \tag{reorder bindings}
%    \abst{\abst{A}{B}}{\abst{C}{\hole}} \implies{\wfz} \abst{\abst{A}{C}}{\abst{B}{\hole}}\\
    \tag{empty contexts}
...
%    (A \equiv B) \implies{\wfz} \context{A}{C} \context{B}{D}\\
%    \abst{\abst{A}{B}C}{\abst{\hole}{\hole}F} \equiv \abst{\abst{\abst{A}{B}}{C}}{}\\
...
%  \end{equation*}
  ...
  \begin{align*}
    ...
    \mathrm{not} &:= (\nameabst{P} \neg P)\\
%    \tag{conjunction}
%    P \land Q &:= (\nameabst{R} (P \implies Q \implies R) \implies R)\\
%    \mathrm{and} &:= (\nameabst{P}\nameabst{Q} P \land Q)\\
%    \tag{disjunction}
