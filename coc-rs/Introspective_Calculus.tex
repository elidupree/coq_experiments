...
\begin{document}
  ...
  \begin{align*}
    ...
    (\forall x, \forall a, \forall b, \singleton{\singleton{x \in ab} \infrule \singleton{x \in \all a}})\\
  \end{align*}
  ...
  \begin{align*}
    ...
    \globalrule{R \concludes A \presep (A \infrule B) \in R}{R \concludes B} \\
  ...
  \begin{align*}
    \globalrule{\deduction \concludes A}{A} && 
    \globalrule{A}{\deduction \concludes A}
  \end{align*}
  ...
  \begin{align*}
    \globalrule{\deduction_2 \concludes A}{A} && 
    \globalrule{A}{\deduction_2 \concludes A}
  \end{align*}
