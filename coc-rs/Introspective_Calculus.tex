...
\begin{document}
  ...
  \begin{align*}
    Atom &:= \const \mid \fuse \mid \atomimplies \mid \atomall \mid \atomfoldsto\\
    F &:= Atom \mid FF \\
  \end{align*}
